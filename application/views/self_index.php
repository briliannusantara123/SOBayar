...
<div class="container " style="z-index: 10000;position: fixed;width: 100%;margin-top: 55px;">
  <div class="row">
    <div class="col" style="margin-left:30px;border-bottom-left-radius: 20px;padding-top: 10px;background-color:#223c77;  ">
      <p style="color: white;"><?= date('d-m-y H:i:s'); ?></p>
      <p style="color: white;">Table No : <?= $this->session->userdata('nomeja') ?></p>
    </div>
  
    <div class="col" style="margin-right:30px;border-bottom-right-radius: 20px;padding-top: 10px;background-color:#223c77; ">
