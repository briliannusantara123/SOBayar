...
<div class="container text-center">
  <div class="row">
    ...
    <div class="col">
      ...
      <?php if ($cekbk): ?>
        <a href="<?= base_url() ?>index.php/selforder/cetakpdf/bk" class="btn btn-outline-primary" id="btn_kanan_awal"onclick="showBackToHome()"><i class="fa fa-file"></i> Export PDF</a>
      <?php else: ?>
        <a href="<?= base_url() ?>index.php/selforder/cetakpdf" class="btn btn-outline-primary" id="btn_kanan_awal"onclick="showBackToHome()"><i class="fa fa-file"></i> Export PDF</a>
      <?php endif ?>
    </div>
  </div>
</div>
