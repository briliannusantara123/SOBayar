...
#icon {
  ...
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="<?= base_url();?>assets/logoDVLogin.png" style="width: 270px;height: 100px; margin-top: 70px;margin-bottom: 10px;" alt="Dear Clio" />
      <h1>Self Order</h1>
    </div>
    ...
    <form action="<?= base_url() ?>index.php/Login/log/<?= $nomeja ?>" method="post">
      ...
      <button class="btn" style="color: white;margin-bottom: 20px; padding-right: 50px;padding-left: 50px; margin-top: 10px;background-color:#223c77">Log In</button>
    </form>
