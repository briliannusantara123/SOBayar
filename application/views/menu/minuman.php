        ...
        <div class="container text-center" style="position:relative;">
          ...
          <div class="row">
            <div class="col" style="margin-top:10px;">
              ...
              <?php  else: ?>
                <h5 id="qtycart<?= $i->id ?>" class="qtycart<?= $i->id ?>" style="font-size: 12px;float: right;background-color: red;border-radius: 20px;padding: 3px;color: white;">Cart Qty 0</h5>
                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $i->id ?>"><img src="<?= base_url();?>assets/logo.png" alt="Red dot" style="width: 160px;height: 100px;border-radius: 20px;" /></a>
              <?php endif ?>
          ...
          <div class="row" style="margin-top: 5px;">
            <div class="col" >
              <button type="button" class="btn btn-primary kurang<?= $i->id ?>" style="padding-left: 9px;padding-right: 9px;" id="kurang<?= $i->id ?>" onclick="OrderQty('minus','<?= $i->id ?>','<?= $i->no ?>','<?= $i->stock ?>','<?= $i->need_stock ?>','<?= $this->session->userdata('user_order_id') ?>');"> - </button>
            </div>
            <div class="col">
            ...
            <div class="col">
              <?php $options = $this->Item_model->option($i->no); ?>
              <?php if ($i->with_option == 1 || $i->with_option == 2): ?>
                <button type="button" class="btn btn-primary nambah<?= $i->id ?>" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $i->id ?>" style="padding-left: 7px;padding-right: 7px;">+</button>
              <?php else: ?>
                <button type="button" class="btn btn-primary tambah<?= $i->id ?>" style="padding-left: 7px;padding-right: 7px;" id="tambah<?= $i->id ?>" onclick="OrderQty('plus','<?= $i->id ?>','<?= $i->no ?>','<?= $i->stock ?>','<?= $i->need_stock ?>','<?= $this->session->userdata('user_order_id') ?>');">+</button>
              <?php endif ?>
              </div>
            </div>
          </div>
        ...
        <div class="container text-center sold" style="position:relative;">
          ...
          <a href="#"><img src="<?= $i->image_path ?>" alt="Red dot" style="width: 120px;height: 120px;border-radius: 20px;opacity: 075;" /><div class="soldtext">SOLD OUT</div></a>
              ...
              <?php  else: ?>
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $i->id ?>"><img src="<?= base_url();?>assets/logo.png" alt="Red dot" style="width: 160px;height: 100px;border-radius: 20px;" /><div class="soldtext">SOLD OUT</div></a>
              <?php endif ?>
              <h6 style="color: #223c77;font-size: 16px;"class="text_<?= str_replace(" ","_", $i->description)?> text"><?= $i->description ?></h6>
          ...
          <div class="row" style="margin-top: 5px;">
            <div class="col" >
              <button type="button" class="btn btn-primary" style="padding-left: 9px;padding-right: 9px;opacity:0.7"> - </button>
            </div>
            <div class="col">
                <!-- <?php if ($i->id_customer != $ic): ?>
                  <input type="text" name="qty<?= $i->id ?>" id="qty<?= $i->id ?>"  value="0"  class="form-control" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:35px; " readonly>
            ...
            <div class="col">
              <?php $options = $this->Item_model->option($i->no); ?>
              <?php if ($i->with_option == 1 || $i->with_option == 2): ?>
                <button type="button" class="btn btn-primary" style="padding-left: 7px;padding-right: 7px;opacity:0.7">+</button>
              <?php else: ?>
                <button type="button" class="btn btn-primary" style="padding-left: 7px;padding-right: 7px;opacity:0.7">+</button>
              <?php endif ?>
              </div>
...
<div class="container text-center" id="tk<?= $i->id ?>" hidden >
  <div class="row">
    <div class="col" >
      ...
      <button type="button" class="btn btn-primary mi<?= $i->id ?>" style="padding-left: 10px;padding-right: 10px;"> - </button>
    </div>
    <div class="col">
    ...
    <div class="col">
      <button type="button" class="btn btn-primary pl<?= $i->id ?>" id="pls<?= $i->id ?>" style="padding-left: 10px;padding-right: 10px;">+</button>
    </div>
  </div>
</div>
...
<footer>
<div class="container text-center">
<!-- <button type="submit" class="btn btn-outline-primary" style="padding-top: 20px;padding-bottom: 20px;padding-left: 50px;padding-right: 50px;">
  Order 
</button> -->
<a href="<?php echo base_url() ?>index.php/Cart/home/<?= $nomeja ?>/Minuman/<?= $s ?>#<?= $s ?>" class="btn btn-outline-primary" style="padding-top: 20px;padding-bottom: 20px;padding-left: 40px;padding-right: 40px;">Cart<i class="fa fa-cart-plus"></i> <b id="total_qty" align="right"><?= $total_qty;?></b></a>
  ...
  <div class="modal-dialog">
    ...
    <form action="#" method="post" id="input<?= $i->id ?>">
      ...
      <div class="row row-cols-auto">
        <?php if ($i->with_option == 1 || $i->with_option == 2): ?>
        <div class="col"><button type="button" class="btn btn-primary minus<?= $i->id ?>" style="padding-left: 15px;padding-right: 15px;"> - </button></div>
        ...
        <div class="col"><button type="button" class="btn btn-primary plus<?= $i->id ?>" style="padding-left: 15px;padding-right: 15px;">+</button></div>

      </div>
    </div>
    <!-- <button type="button" class="btn btn-primary" style="padding-left: 45px;padding-right: 45px;" data-bs-dismiss="modal" aria-label="Close">Tambah Ke Keranjang <a id="total<?= $i->id ?>"></a></button> -->
    <button id="simpan<?= $i->id ?>" type="button" class="btn btn-primary" data-bs-dismiss="modal" aria-label="Close"  onclick="simpanalert('<?= $i->need_stock ?>')">Add to Cart <a id="total<?= $i->id ?>"></a></button>
    <?php endif ?>
      </div>
...
if (localStorage.getItem('<?=$i->no?>')) {
  ...
  simpan<?= $i->id ?>.addEventListener("click", ()=>{
    ...
    if (window.location.toString() == "<?= base_url() ?>index.php/oorderminuman/menu/Minuman/Cold%20Drink#Soft_Drinks") {
      var h = '<?= base_url() ?>index.php/oorderminuman/menu/Minuman/Cold%20Drink#Soft_Drinks';
          // alert(h);
          $('#konten').load(h);
      window.location.href = "<?= base_url() ?>index.php/oorderminuman/menu/Minuman/Soft%20Drinks#Soft_Drinks";
    }else if (window.location.toString() == "<?= base_url() ?>index.php/oorderminuman/menu/Minuman/Cold%20Drink#Cold_Drink") {
      var h = '<?= base_url() ?>index.php/oorderminuman/menu/Minuman/Cold%20Drink#Cold_Drink';
          // alert(h);
          $('#konten').load(h);
      window.location.href = "<?= base_url() ?>index.php/orderminuman/menu/Minuman/Cold%20Drink#Cold_Drink";
    }
  ...
  if (simpan<?= $i->id ?>) {
    ...
    if (window.location.toString() == "<?= base_url() ?>index.php/orderminuman/menu/Minuman/Cold%20Drink#Soft_Drinks") {
      var h = '<?= base_url() ?>index.php/orderminuman/menu/Minuman/Soft%20Drinks#Soft_Drinks';
          // alert(h);
          $('#konten').load(h);
      window.location.href = "<?= base_url() ?>index.php/orderminuman/menu/Minuman/Cold%20Drink#Soft_Drinks";
    }else if (window.location.toString() == "<?= base_url() ?>index.php/orderminuman/menu/Minuman/Cold%20Drink#Cold_Drink") {
      var h = '<?= base_url() ?>index.php/orderminuman/menu/Minuman/Cold%20Drink#Cold_Drink';
          // alert(h);
          $('#konten').load(h);
      window.location.href = "<?= base_url() ?>index.php/orderminuman/menu/Minuman/Cold%20Drink#Cold_Drink";
    }
